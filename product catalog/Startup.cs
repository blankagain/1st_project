...
namespace product_catalog
{
    public class Startup
    {
        ...
        {
            //   services.AddIdentity<product_catalogUser, IdentityRole>()
            ...
            services.AddDbContext<ProductContext>(options => options.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=Product_Catalog;Trusted_Connection=True;"));
